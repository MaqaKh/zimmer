...
<!-- Mirrored from p.w3layouts.com/demos_new/template_demo/07-04-2021/execution-liberty-demo_Free/985771955/web/landing-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 23 Dec 2023 13:30:26 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <title>Execution - Corporate Category Bootstrap Responsive Website Template - Landing Page : W3Layouts</title>
    <!-- google-fonts -->
                    ...
                    <ul class="navbar-nav ml-lg-auto">
                        ...
                        <li class="nav-item">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <a class="dropdown-item" href="#video">Our Video</a>
                ...
                <div class="row top-cont-grid align-items-center">
                    ...
                    <div class="col-lg-6 text-6-info mb-lg-0 mb-5 pl-xl-5 order-lg-last order-first">
                        ...
                        <p class="mt-4">Sed luctus orci sit amet tempor luctus. Nullam non felis massa ipsum dolor sit
                            amet.</p>
                        <a href="#blog-single" class="btn btn-style mt-lg-5 mt-4">Learn More</a>
                    </div>
                </div>
            </div>
        </div>
...
<!---728x90--->
                ...
                <div class="col-lg-4 col-md-6 item">
                    <div class="card">
                        ...
                        <div class="card-body service-details">
                            ...
                            <a href="#services" class="service-heading">Website Designing</a>
                ...
                <div class="col-lg-4 col-md-6 mt-md-0 mt-4">
                    <div class="card">
                        ...
                        <div class="card-body service-details">
                            ...
                            <a href="#services" class="service-heading">Mobile Applications</a>
                            <p>Sed ut perspiciatis unde omnis iste natus sit accusantium doloremque
                                laudantium, totam rem aperiam</p>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 mt-lg-0 mt-4">
                    <div class="card">
                        ...
                        <div class="card-body service-details">
                            ...
                            <a href="#services" class="service-heading">Digital Marketing</a>
                            <p>Sed ut perspiciatis unde omnis iste natus sit accusantium doloremque
                                laudantium, totam rem aperiam</p>
                        </div>
                    </div>
    ...
    <!-- about section -->
    <div class="w3l-content-photo-5 py-5" id="video">
    ...
    <!-- blog section -->
    <div class="w3l-homeblock2 py-5" id="blog">
        <div class="container py-md-5 py-4">
            <div class="row align-items-center mb-5">
                <div class="col-md-6 section-heading">
                    ...
                    <div class="contact-address p-4">
                        <div class="contact-icon d-flex align-items-center">
                            ...
                            <div class="ml-3">
                                ...
                                <a href="https://p.w3layouts.com/cdn-cgi/l/email-protection#85ecebe3eac5e0fde4e8f5e9e0abe6eae8"> <span class="__cf_email__" data-cfemail="4c25222a230c29342d213c2029622f2321">[email&#160;protected]</span></a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container py-md-5 py-4">
            <div class="row sub-columns">
                ...
                <div class="col-lg-3 col-sm-6 sub-two-right pl-lg-5 mt-sm-0 mt-5">
                    <h6>Our Services</h6>
                    <ul>
                        <li><a href="#services"><span class="fas fa-angle-right mr-2"></span>Website Designing</a>
                        </li>
                        <li><a href="#services"><span class="fas fa-angle-right mr-2"></span>Web Hosting</a>
                        </li>
                        <li><a href="#services"><span class="fas fa-angle-right mr-2"></span>Digital Photography</a>
                        </li>
                        <li><a href="#services"><span class="fas fa-angle-right mr-2"></span>Photoshop to HTML</a>
                        </li>
                    </ul>
                </div>
                <div class="col-lg-2 col-sm-6 sub-two-right mt-lg-0 mt-sm-5 mt-4">
                    ...
                    <ul>
                        ...
                        <li><a href="#contact"><span class="fas fa-angle-right mr-2"></span>Contact</a></li>
                    </ul>
                </div>
            ...
            <div class="sub-contact mt-5 pt-lg-4">
                <div class="row">
                    <div class="col-md-4 footer-contact d-flex align-items-center">
                        ...
                        <div>
                            <a href="https://p.w3layouts.com/cdn-cgi/l/email-protection#deb7b0b8b19ebba6bfb3aeb2bbf0bdb1b3"><span class="__cf_email__" data-cfemail="254c4b434a65405d44485549400b464a48">[email&#160;protected]</span></a>
                            <p>Drop Us a Line</p>
                        </div>
                    </div>
...
<script>(function(){var js = "window['__CF$cv$params']={r:'83a0f4d67bc68ecf',t:'MTcwMzMzODE5Ny43NDkwMDA='};_cpo=document.createElement('script');_cpo.nonce='',_cpo.src='../../../../../../cdn-cgi/challenge-platform/h/g/scripts/jsd/74bd6362/main.js',document.getElementsByTagName('head')[0].appendChild(_cpo);";var _0xh = document.createElement('iframe');_0xh.height = 1;_0xh.width = 1;_0xh.style.position = 'absolute';_0xh.style.top = 0;_0xh.style.left = 0;_0xh.style.border = 'none';_0xh.style.visibility = 'hidden';document.body.appendChild(_0xh);function handler() {var _0xi = _0xh.contentDocument || _0xh.contentWindow.document;if (_0xi) {var _0xj = _0xi.createElement('script');_0xj.innerHTML = js;_0xi.getElementsByTagName('head')[0].appendChild(_0xj);}}if (document.readyState !== 'loading') {handler();} else if (window.addEventListener) {document.addEventListener('DOMContentLoaded', handler);} else {var prev = document.onreadystatechange || function () {};document.onreadystatechange = function (e) {prev(e);if (document.readyState !== 'loading') {document.onreadystatechange = prev;handler();}};}})();</script></body>
